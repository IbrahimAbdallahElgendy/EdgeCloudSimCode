...
public class DefaultEdgeServerManager extends EdgeServerManager{
	...
	//*Mine* This method is defined by me to get number of edge data center
	public int getNumberOfEdgeDataCenter(){
		return localDatacenters.size();
	}
	
	//*Mine* This method is defined by me to get number of host on edge data center
		public int getNumberOfHostOnEdge(){
			return vmList.size();
		}
	
	//*Mine* This method is defined by me to get number of VM on edge data center
		public int getNumberOfVMOnEdge(){
			int count=0;
