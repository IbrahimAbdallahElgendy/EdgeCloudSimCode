...
public class RWPMobility extends MobilityModel {
	...
	//*Mine* this method is print each device locations and its associated edge data center through the simulation time
		public void printDeviceLocations(){
			...
			String FileLocation="E:\\HIT\\OneDrive - Computer and Information Technology (Menofia University)\\My Papers\\Git Code\\Other codes\\Cloud_EdgeSim_Code\\cloudsim-3.0.3\\scripts\\sample_app3\\config\\Files\\DeviceLocations_RWPMobility.txt"; 
