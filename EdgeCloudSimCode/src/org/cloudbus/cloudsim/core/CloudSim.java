...
public class CloudSim {
	...
	protected static void initialize() {
		Log.printLine("CloudSim Initialising...");
	...
	public static boolean runClockTick() {
		...
		//System.out.println("Size of Entites "+entities_size);
		...
		//System.out.println("Size of FutureQueue is "+future.size());
	...
	private static void processEvent(SimEvent e) {
		...
		clock = e.eventTime();
		//System.out.println("Mine (ProcessEvent method in CloudSim Class) Event Time: "+clock );
	...
	public static void runStart() {
		...
		//*Mine* This loop call startEntity() method in the following classes:
		//*Mine* CloudSimShutdown, CloudInformationService, SimManager, SampleEdgeOrchestrator and SampleMobileDeviceManager 
		for (SimEntity ent : entities) {
			ent.startEntity();
		}

		printMessage("Entities started.(CloudSim Class : runStart Method)");
	}
	...
	//*Mine* Defined by me to get the future queue 
