...
public class SampleEdgeOrchestrator extends EdgeOrchestrator {
	...
	public int getDeviceToOffload(Task task) {
		int result = 0;
		System.out.println("SampleEdgeOrchestrator Class getDeviceToOffload Method");
	...
	public Vm getVmToOffload(Task task, int deviceId) {
		Vm selectedVM = null;
		System.out.println("SampleEdgeOrchestrator Class getVmToOffload Method");
	...
	//*Mine* I added this meyhod
	public int getNumofHost(){
		return numberOfHost;
	}
